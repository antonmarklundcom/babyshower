...
function home(route, page) {
 ...
 <section class="theme-section"><div class="wrap"><div class="theme-heading"><h2>${esc(UI.themes)}</h2>${p(FAQ[12].a + ' ' + UI.illustrativeImages)}</div>${themeGrid()}${link('/tematicas/', UI.themesLink, 'tematicas', 'home-more')}</div></section>
