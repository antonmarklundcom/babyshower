...
export const UI = {
 ...
 hero: `Decoración, mesa dulce y bocaditos para 30 invitados. ${priceCaption(PACKAGES[1].price)} ${RESPONSE} Precios estimados a la vista, sin preguntar al privado.`,
 consentTitle: 'Tus preferencias de cookies', consent: 'Usamos analítica solo si aceptás. Podés rechazarla o revocar tu consentimiento desde el pie de página. Ley 6534/2020.', accept: 'Aceptar', reject: 'Rechazar', preferences: 'Preferencias de cookies',
 ...
 form: { nombre: 'Tu nombre', whatsapp: 'Tu WhatsApp', fecha: 'Fecha tentativa', unknown: 'No sé todavía', invitados: 'Cantidad de invitados', tipo: 'Tipo de evento', zona: 'Zona', mensaje: 'Mensaje (opcional)', submit: 'Enviar consulta', choose: 'Elegí una opción', privacy: 'Consultá cómo tratamos tus datos', types: [['baby-shower', 'Baby shower'], ['revelacion', 'Revelación de género'], ['primer-anito', 'Primer añito'], ['otro', 'Otro']] },
...
export const PAGES = {
 ...
 '/privacidad/': { title: 'Privacidad | Baby Shower Paraguay', description: 'Conocé qué datos recibimos, para qué los usamos y cómo pedir su eliminación. Podés aceptar, rechazar o revocar la analítica del sitio.', h1: 'Privacidad', type: 'privacy' },
