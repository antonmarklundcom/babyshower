...
export const UI = {
 ...
 eyebrow: 'Baby shower en Asunción y Gran Asunción', packagesEyebrow: 'Combos', packages: 'Tres combos con precios estimados a la vista', calculator: 'Calculadora', calcTitle: 'Consultá tu estimación', band: 'Vos elegís la temática. Coordinamos horario de montaje con vos.', steps: 'Cómo funciona', stepsLink: 'Ver cómo funciona en detalle', moreGuides: 'Más guías para organizar tu evento', themes: 'Temáticas para tu celebración', zones: 'Asunción y Gran Asunción', faq: 'Preguntas frecuentes', reveal: 'Revelación', revealLink: 'Consultá por una revelación de género', who: 'Quiénes somos', payments: 'Impuestos y formas de pago', contact: 'Escribinos y contanos tu idea', estimation: 'Estimación orientativa',
