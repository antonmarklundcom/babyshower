...
| `/servicios/` | servicios decoración eventos asunción | Servicios de decoración para celebraciones familiares | hero · 7 service cards with lowest configured price · steps · zones · FAQ (3) · CTA band | Consultá por WhatsApp |
| `/decoracion-con-globos/`, `/bautismo/`, `/cumpleanos-infantil/`, `/bienvenida-de-bebe/` | decoracion con globos / decoracion para bautizo / decoracion cumpleaños infantil / bienvenida bebe (KWP 2026-09) | from SERVICES in content.mjs | hero · offer cards (estimated prices confirmed by Anton 2026-09-25) · Ideal para · main paragraph · themes · guides · other services · FAQ (3) | Consultá por WhatsApp |
...
Idea slugs: `ideas-para-baby-shower`, `juegos-para-baby-shower`, `baby-shower-sencillo-en-casa`, `revelacion-de-genero-sencilla`, `que-se-necesita-para-un-baby-shower`, `centros-de-mesa-para-baby-shower`, `que-regalar-en-un-baby-shower`, `baby-shower-de-nina`, `fiesta-de-primer-anito`.
